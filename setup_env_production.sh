...
echo NEW_RELIC_APP_NAME=$NEW_RELIC_APP_NAME_PRODUCTION >> .env.production
echo NEW_RELIC_LICENSE_KEY=$NEW_RELIC_LICENSE_KEY_PRODUCTION >> .env.production
echo NEW_RELIC_LOG=stdout >> .env.production
echo BUGSNAG_KEY=$BUGSNAG_KEY >> .env.production
echo BUGSNAG_STAGE=$BUGSNAG_STAGE_PROD >> .env.production
